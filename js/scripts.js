...
function bot_reply(input, first_msg = false){
    ...
    if (first_msg){
        rowHTML += "<div class='p-1 my-1 mx-2 pr-auto mr-1 bg-secondary'>";
    } else {
        rowHTML += "<div class='p-1 my-1 mx-2 mr-1 bg-secondary d-flex align-items-center justify-content-start text-center'>";
    }
    rowHTML += 
...
function user_reply(input){
    ...
    rowHTML += "<div class='p-1 my-1 mx-2 pl-auto bg-secondary d-flex align-items-center justify-content-end text-center'>" +
