...
function bot_reply(input, first_msg = false){
    ...
    if (first_msg){
        rowHTML += "<div class='row p-1 mt-auto mb-1 mx-2 pr-auto mr-1 bg-secondary msg-height d-flex align-items-center justify-content-start text-center'>";
    } else {
...
function user_reply(input){
    ...
    rowHTML += "<div class='row msg-height p-1 my-1 mx-2 pl-auto bg-secondary d-flex align-items-center justify-content-end text-center'>" +
        ...
        "<img src='./img/user.png' alt'...' class='p-2 m-1 bg-warning'></div>";
